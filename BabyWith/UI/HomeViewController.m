...
-(void)HeaderView
{
    ...
    for(int i=0;i<[arr count];i++)
    {
        ...
        [buttonTitle setBackgroundImage:[UIImage imageNamed:@"buttonBG.png"] forState:UIControlStateNormal];
        [buttonTitle setBackgroundImage:[UIImage imageNamed:@"buttonBG.png"] forState:(UIControlStateSelected|UIControlStateHighlighted)];
        ...
        [jiantou setImage:[UIImage imageNamed:@"redjiantou.png"]];
        ...
        if(i==1)
        {
            ...
            tuisongLabel.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"信息提示背景.png"]];
...
//    [deviceDic setObject:[[self.deviceArray objectAtIndex:indexPath.row] objectForKey:@"id_member"] forKey:[[self.deviceArray objectAtIndex:indexPath.row] objectForKey:@"device_id"]];
    ...
    [cell3.image setImage:[UIImage imageNamed:@"设备.png"]];
